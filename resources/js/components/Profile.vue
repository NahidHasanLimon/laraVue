              ...
              <div class="tab-pane active show" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control"v-model="form.biography" id="biography" placeholder="biography"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="file" class="form-control" @change="updateProfile"   name="photo" id="photo"
